...
<body>
    ...
    <div class="content">
        <div class="container">
            <div class="about-us terms_txt">
                <div class="row">

                    <div class="col-md-12 col-lg-12 col-12">
                        <h3>SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</h3>
                        <ul>
                            <li> When you purchase something from our store, as part of the buying and selling process,
                                we collect the personal information you give us such as your name, address, mobile
                                number, and email address. </li>
                            <li>When you browse our store, we also automatically receive your computer's internet
                                protocol (IP) address to provide us with information that helps us learn about your
                                browser and operating system.</li>
                            </li>
                            <li>Promotional, transactional & commercial communications (if applicable): With your
                                permission, we may send you emails, WhatsApp messages and SMS about our store, new
                                products, and other updates.</li>
                        </ul>
                        ...
                        <p>By browsing, accessing, subscribing to or using any of our services you agree that you have
                            read, understood and are bound by the terms, regardless of how you subscribe to or use the
                            services. In these terms, references to "Website" shall mean the Biryani Fiesta website,
                            "you", "user" shall mean the end user accessing the Website, its contents and using the
                            services offered through Biryani Fiesta, "Service Providers" mean independent third party
                            service providers, and "we", "us"; and "our" shall mean Biryani Fiesta and its affiliates.
                        ...
                        <p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact
                            ...
                            contacting us at support@fiestabiryani.com</p>
                        ...
                        <p>Our payment gateway adheres to the standards set by PCI-DSS as managed by the PCI Security
                            ...
                            and Discover.</p>
                        <p>PCI-DSS requirements help ensure the secure handling of credit card information by our store
                            and its service providers. For more insight, you may also want to read terms and conditions
                            of Razorpay on https://razorpay.com</p>
                        ...
                        <p>For these providers, we recommend that you read their privacy policies so you can understand
                            the way your personal information will be handled by these providers.</p>

                        <p>Remember that certain providers may be located in or have facilities that are located in a
                            different jurisdiction than either you or us. So if you elect to proceed with a transaction
                            that involves the services of a third-party service provider, then your information may
                            become subject to the laws of the jurisdiction(s) in which that service provider or its
                        ...
                        <p>To protect your personal information, we take reasonable precautions and follow industry best
                            practices to make sure it is not inappropriately lost, misused, accessed, disclosed,
                            altered, or destroyed.</p>
                        ...
                        <p>If you would like to: access, correct, amend or delete any personal information we have about
                            you, register a complaint, or simply want more information to contact our Privacy Compliance
                            Officer at support@fiestabiryani.com</p>
                    </div>
